...
public class TestBoardState {
    ...
    public void testGetCell() {
        ...
        board1.setCell(new Point(3,4), Cell.FOX);

        Assert.assertEquals(board1.getCell(new Point(3,4)), Cell.FOX);
    ...
    public void testEquals() {
        ...
        board2.setCell(new Point(2,2), Cell.RABBIT);
    ...
    public void testCopyIsDeep() {
        ...
        board2.setCell(new Point(2,2), Cell.FOX);
